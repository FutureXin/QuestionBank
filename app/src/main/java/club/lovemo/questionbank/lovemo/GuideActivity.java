...
public class GuideActivity extends Activity {
	...
	private static final int[] mImageIds = new int[] { R.mipmap.right_arrow,
			R.mipmap.been_praised, R.mipmap.back };
	...
	private void initViews() {
		...
		for (int i = 0; i < mImageIds.length; i++) {
			...
			LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
					Utils.dptopx(this, 10), Utils.dptopx(this, 10));
			if (i > 0) {
				params.leftMargin = Utils.dptopx(this, 10);// 设置圆点间隔
			}
		...
		llPointGroup.getViewTreeObserver().addOnGlobalLayoutListener(
				new OnGlobalLayoutListener() {
					...
					public void onGlobalLayout() {
						...
						//removeOnGlobalLayoutListener版本必须高于16
