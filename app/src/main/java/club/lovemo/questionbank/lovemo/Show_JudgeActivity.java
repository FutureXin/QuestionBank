...
public class Show_JudgeActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState ) {
        ...
        judge_toolbar=(Toolbar)findViewById(R.id.judge_toolbar);
        show_judge_topic=(TextView)findViewById(R.id.show_judge_topic);
        show_judge_answer=(TextView)findViewById(R.id.show_judge_answer);
        show_judge_detailed=(TextView)findViewById(R.id.show_judge_detailed);
        judge_detailed=(TextView)findViewById(R.id.judge_detailed);
        show_judge_answer_btn=(Button)findViewById(R.id.show_judge_btn);
        show_judge_praise_btn=(ImageButton)findViewById(R.id.show_judge_praise);
        show_judge_praise_count=(TextView)findViewById(R.id.show_judge_praise_count);
        show_judge_url=(TextView)findViewById(R.id.show_judge_url_text);
        ...
        judge_toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Show_JudgeActivity.this.overridePendingTransition(R.anim.in_from_right,R.anim.out_to_left);
            }
        });
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_feedback://点击了反馈按钮
                        ...
                        feedback_intent.setClass(Show_JudgeActivity.this,FeedbackActivity.class);
                        feedback_intent.putExtra("id",ID);
                        Show_JudgeActivity.this.startActivity(feedback_intent);
                        Show_JudgeActivity.this.overridePendingTransition(R.anim.in_from_right,R.anim.out_to_left);
                        break;
                                    ...
                                    public void done(List<Collection> list, BmobException e) {
                                        if(e==null){
                                            ...
                                            if(e.getErrorCode()==101){
                                                ...
                                                Utils.showToast(Show_JudgeActivity.this,getResources().getString(R.string.text_no_network));
                                            }else {
                ...
                praiseQuery.addWhereEqualTo("UserId",myUser.getObjectId()).addWhereEqualTo("QuestionId",ID)
                        .findObjects(new FindListener<Praise>() {
                            ...
                            public void done(List<Praise> list, BmobException e) {
                                if(e==null){
                                    if(list!=null&&list.size()>0){
                                        Utils.showToast(Show_JudgeActivity.this,getResources().getString(R.string.text_been_great));
                                    ...
                                    if(e.getErrorCode()==101){
                                        ...
                                        Utils.showToast(Show_JudgeActivity.this,"error:"+e.getMessage()+e.getErrorCode());
                                    }
                                }
                            }
                        });
    ...
    private void addCollection(String userId,String Type,String Topic,String CHARACTERISTIC){
        ...
        collection.save(new SaveListener<String>() {
            ...
            public void done(String objectId, BmobException e) {
                if(e==null){
                    Utils.showToast(Show_JudgeActivity.this , getResources().getString(R.string.text_collection_success));
                    judge_toolbar.getMenu().findItem(R.id.action_collect).setIcon(R.mipmap.already_collected);//改变图标样式
                }else {
                    Utils.showToast(Show_JudgeActivity.this, getResources().getString(R.string.text_collection_failure));
                    if(e.getErrorCode()==9016){
                        Utils.showToast(Show_JudgeActivity.this,getResources().getString(R.string.text_no_network));
                    }else {
    ...
    private void CancelCollection(String Id){
        ...
        collection.delete(new UpdateListener() {
            ...
            public void done(BmobException e) {
                if(e==null){
                    Utils.showToast(Show_JudgeActivity.this,getResources().getString(R.string.text_cancel_collection_success));
    ...
    private void addPraise(String userId, final String questionId){
        ...
        praise.save(new SaveListener<String>() {
            ...
            public void done(String objectId, BmobException e) {
                if(e==null){
                    Utils.showToast(Show_JudgeActivity.this,getResources().getString(R.string.text_thumb_success));
